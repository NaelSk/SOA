...
<jsp:useBean id="sampleCalculatorProxyid" scope="session" class="com.learn.ws.CalculatorProxy" />
<%
...
case 10:
        gotMethod = true;
        com.learn.ws.Calculator getCalculator10mtemp = sampleCalculatorProxyid.getCalculator();
