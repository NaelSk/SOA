...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.learn.ws.CalculatorService {
    ...
    public com.learn.ws.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.learn.ws.CalculatorSoapBindingStub _stub = new com.learn.ws.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.learn.ws.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.learn.ws.CalculatorSoapBindingStub _stub = new com.learn.ws.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.learn.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.learn.com", "Calculator"));
        }
