...
{
	window.document.getElementById('div3').style.display = 'none';
	var cur_str='type=currency&value'+document.getElementById('t5').value;
	doAjax('MyConvertor_Servlet',cur_str,'currencyNameBack','post',0);
	}

function currencyNameBack(){
...
{
    window.document.getElementById('div3').style.display = 'none';
    var q_str = 'type=number&value='+document.getElementById('t1').value + '&currency='+document.getElementById('t5').value;
