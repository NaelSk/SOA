...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements ws.CalculatorService {
    ...
    public ws.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public ws.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.CalculatorSoapBindingStub _stub = new ws.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.CalculatorSoapBindingStub _stub = new ws.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws", "Calculator"));
        }
